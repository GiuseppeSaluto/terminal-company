...
lazy_static! {
    ...
    Monster {
            ...
            danger_level: Some("90%".to_string()),
            power_level: 1.0,
        ...
        Monster {
            ...
            danger_level: Some("70%".to_string()),
            power_level: 3.0,
        ...
        Monster {
            ...
            danger_level: Some("100%".to_string()),
            power_level: 3.0,
        ...
        Monster {
            ...
            danger_level: Some("50%".to_string()),
            power_level: 3.0,
        ...
        Monster {
            ...
            danger_level: Some("30%".to_string()),
            power_level: 1.0,
        ...
        Monster {
            ...
            danger_level: Some("80%".to_string()),
            power_level: 1.0,
